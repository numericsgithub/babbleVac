...
void setup() {
  ...
  Serial.println("setSDCSPin");
  if (!SdPlay.init(SSDA_MODE_FULLRATE | SSDA_MODE_MONO | SSDA_MODE_AUTOWORKER))
  {
    Serial.println("SdPlay.init FAIL");
    while(1);
  }
  if(!SdPlay.setFile("ouch3.wav")) // music name file
  {
...
//  Serial.print(" "); Serial.println(convert_int16_to_str(gyro_z));
  ...
  Serial.print(" "); Serial.println(convert_int16_to_str(accelerometer_y));
